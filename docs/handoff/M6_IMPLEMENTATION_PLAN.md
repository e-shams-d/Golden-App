...
| **G-9** | **The approved-batch cancellation conflict** (§2.4): §29.2 permits it and the diagram draws no arrow. M6 does not reach `approved`, so this is recorded for M7 rather than resolved here. | M7 |
