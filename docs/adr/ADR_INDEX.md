...
Decision state: ADR-006 and POL-005 Approved; 31 entries remain Open
...
|---|---|---|---|---|---|---|---|---|---|---|
| ADR-001 | Browser authentication and session transport | Core / Identity | ADR-SEC-001; ADR-SEC-002; ADR-OPS-005 | ADR-SEC-001 proposed_mapping; ADR-SEC-002 needs_mapping because it covers session timeouts only; ADR-OPS-005 proposed_mapping | Keep transport behind an interface; do not finalize or claim production-ready authentication until approved. | TBD | TBD | TBD | M3 final auth; M12 security review; M13 production | Open_ADR_Register.md:10; 12_Security_RBAC_Audit.md:2553-2554; 13_DevOps_Deployment_Operations.md:2473 |
| ADR-002 | Production hosting provider, region, and topology | Core / Operations | ADR-OPS-001; ADR-SEC-012 | ADR-OPS-001 proposed_mapping; ADR-SEC-012 needs_mapping because it also covers admin network restrictions | Local/staging only; no production environment commitment or procurement. | TBD | TBD | TBD | M12 production-like hardening; M13 production | Open_ADR_Register.md:11; 13_DevOps_Deployment_Operations.md:2469; 12_Security_RBAC_Audit.md:2564 |
...
| ADR-004 | RPO, RTO, backup schedule, restore authority, and ownership | Core / Recovery | ADR-OPS-003; ADR-OPS-004; ADR-SEC-013 | ADR-OPS-003 proposed_mapping; ADR-OPS-004 needs_mapping because it is the backup-design subset; ADR-SEC-013 proposed_mapping | Production release is blocked; backup claims are invalid until a clean full restore drill succeeds. | TBD | TBD | TBD | M12 restore drill; M13 production | Open_ADR_Register.md:13; 13_DevOps_Deployment_Operations.md:2471-2472; 12_Security_RBAC_Audit.md:2565 |
...
| POL-002 | Control for correcting a published paid result | Business / Correction authority | ADR-012; ADR-SEC-009 | proposed_mapping | Manager or dual control; preserve the old publication and evidence. | TBD | TBD | TBD | M9 correction; UAT/production | Open_ADR_Register.md:25; 15_Agent_Implementation_Plan.md:235; 12_Security_RBAC_Audit.md:2561 |
...
| OPS-003 | Production domains, origins, cookie scope, TLS termination, and HSTS rollout | Operations / Edge security | ADR-OPS-005; ADR-SEC-001 | Both needs_mapping because they overlap ADR-001 authentication/session scope | Development/staging origins only; deny broad origins and do not finalize production cookies/TLS/HSTS. | TBD | TBD | TBD | M3 auth deployment; M12/M13 production | Open_ADR_Register.md:38; 13_DevOps_Deployment_Operations.md:2473; 12_Security_RBAC_Audit.md:2553 |
