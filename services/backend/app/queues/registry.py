...
BUILT: dict[str, QueueDefinition[Any]] = {
    NEW_REQUESTS.name: NEW_REQUESTS,
}
...
PLANNED: dict[str, str] = {
    # Accountant — §19.2's eleven, less `new-requests` above. Slice 3.
    "correction-responses": "accountant",
    "eligible-for-batching": "accountant",
    "draft-invalid-batch-versions": "accountant",
    "approved-exports-awaiting-send": "accountant",
    "sent-attempts-awaiting-result": "accountant",
    "unresolved-bundles-segments": "accountant",
    "failed-partial-retry-payments": "accountant",
    "incoming-receipts-requiring-review": "accountant",
    "trader-disputes": "accountant",
    "reconciliation-tasks": "accountant",
