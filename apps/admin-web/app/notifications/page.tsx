 ...
 *
 * M11 Screens, slice 1. The same page as the trader side, and deliberately a separate file:
 * `UI-ISO-001` requires that neither bundle name the other's paths, and notifications are the
 * first surface where both audiences call one route — which is precisely when a shared
 * component looks obviously right and is the mistake the rule exists to prevent.
 *
