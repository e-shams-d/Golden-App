export const faMessages = {
  ...
  // M0 slice B. Bank configuration — four operations M2 and M4 built that no screen reached, so a
  // bank changing a transfer limit or a cutoff time could not be recorded by anybody.
  "bank.nav": "پیکربندی بانک",
  "bank.title": "پیکربندی بانک",
  "bank.profiles": "بانک‌ها",
  "bank.profileTitle": "پیکربندی این بانک",
  "bank.backToList": "بازگشت به فهرست بانک‌ها",
  "bank.noProfilesTitle": "هنوز بانکی ثبت نشده است",
  "bank.noProfiles": "برای شروع، یک بانک تازه با اولین پیکربندی‌اش ثبت کنید.",
  "bank.newProfile": "ثبت بانک تازه",
  "bank.newProfileHint":
    "بانک و اولین نسخهٔ پیکربندی‌اش با هم و در یک تراکنش ساخته می‌شوند. آن نسخه پیش‌نویس است و تا وقتی فعالش نکنید روی هیچ پرداختی اثر ندارد.",
  "bank.code": "کد بانک",
  "bank.displayName": "نام نمایشی",
  "bank.defaultLimit": "سقف انتقال (ریال)",
  "bank.afterCutoffLimit": "سقف پس از ساعت قطع (ریال)",
  "bank.limitBlankMeans": "خالی یعنی این بانک سقفی اعلام نکرده — با صفر یکی نیست.",
  "bank.cutoffTime": "ساعت قطع",
  "bank.splittingEnabled": "این بانک تقسیم مبلغ را می‌پذیرد",
  "bank.supportsDescription": "این بانک فیلد توضیح دارد",
  "bank.createProfile": "ثبت بانک",
  "bank.accounts": "حساب‌های مبدأ",
  "bank.noAccountsTitle": "هنوز حسابی ثبت نشده است",
  "bank.noAccounts": "حسابی که پول از آن خارج می‌شود باید اینجا ثبت شود.",
  "bank.newAccount": "ثبت حساب تازه",
  "bank.accountProfile": "بانک",
  "bank.chooseProfile": "یک بانک انتخاب کنید",
  "bank.iban": "شبا",
  "bank.createAccount": "ثبت حساب",
  "bank.versions": "نسخه‌های پیکربندی",
  "bank.versionNumber": "شماره نسخه",
  "bank.status": "وضعیت",
  "bank.action": "اقدام",
  "bank.inForce": "نسخهٔ در جریان",
  "bank.noneInForce": "هیچ نسخه‌ای فعال نیست",
  "bank.inForceUnknown": "نامشخص",
  "bank.alreadyInForce": "همین الان در جریان است",
  "bank.activate": "فعال کردن",
  "bank.activateConfirm": "مطمئنید؟ این نسخه جایگزین نسخهٔ فعلی می‌شود.",
  "bank.activateYes": "بله، فعال کن",
  "bank.activating": "در حال فعال‌سازی…",
  "bank.activateFailed": "فعال‌سازی انجام نشد.",
  "bank.failedTitle": "پیکربندی بانک خوانده نشد",
  "bank.failed": "اطلاعات پیکربندی بانک دریافت نشد. لطفاً دوباره تلاش کنید.",
