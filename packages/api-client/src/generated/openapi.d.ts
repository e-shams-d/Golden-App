...
export interface components {
  schemas: {
    ...
    "CreateDraftRequest": { amount_irr: string; beneficiary_id: string; description?: string | null; entered_amount_unit?: string | null; entered_amount_value?: string | null; source_attachment_file_id?: string | null; trader_id?: string | null };
    ...
    "DraftRevisionResponse": { amount_irr: string; beneficiary_iban_snapshot: string; beneficiary_name_snapshot: string; content_hash: string; description: string | null; entered_amount_unit: string | null; entered_amount_value: string | null; id: string; revision_number: number };
