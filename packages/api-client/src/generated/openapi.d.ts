...
export interface components {
  schemas: {
    ...
    "PaymentRequestResponse": { beneficiary_id: string; current_revision_id: string | null; id: string; record_version: number; request_number: string; status: string; trader_id: string };
